...
Many third-party modules aren't typed. Now what?
...
* Applications may be migrated incrementally.
* JavaScript compiles as TypeScript without changes.
* Ensure dependencies provide types or that they exist on Definitely Typed.
* Semi-automated tools (ReSharper by JetBrains).
* Loose compiler settings at the start, strict settings to complete migration.
* Leverage Babel.
...
Use JSDoc comments for type checking.
